    ...
    <footer className="bg-yemen-black text-white py-8 mt-12">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div>
            <h3 className="text-lg font-semibold mb-4">اتحاد الطلاب اليمنيين في العراق نجد</h3>
            <p className="text-sm">
        ...
        <div className="border-t border-gray-700 mt-8 pt-6 text-center">
          <p className="text-sm">
            &copy; {new Date().getFullYear()} اتحاد الطلاب اليمنيين في العراق نجد. جميع الحقوق محفوظة.
          </p>
        </div>
      </div>
    </footer>
